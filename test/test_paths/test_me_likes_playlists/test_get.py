...
from soundcloud_python_sdk.paths.me_likes_playlists import get
from soundcloud_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMeLikesPlaylists(ApiTestMixin, unittest.TestCase):
    """
    MeLikesPlaylists unit test stubs
