...
from soundcloud_python_sdk.paths.me_followings_tracks import get
from soundcloud_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMeFollowingsTracks(ApiTestMixin, unittest.TestCase):
    """
    MeFollowingsTracks unit test stubs
