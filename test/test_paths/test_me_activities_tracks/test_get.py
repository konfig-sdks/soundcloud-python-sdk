...
from soundcloud_python_sdk.paths.me_activities_tracks import get
from soundcloud_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMeActivitiesTracks(ApiTestMixin, unittest.TestCase):
    """
    MeActivitiesTracks unit test stubs
