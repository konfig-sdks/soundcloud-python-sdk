...
from soundcloud_python_sdk.paths.users_user_id_favorites import get
from soundcloud_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestUsersUserIdFavorites(ApiTestMixin, unittest.TestCase):
    """
    UsersUserIdFavorites unit test stubs
