...
class Found(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "location", ], str]):
