...
class UserQueryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def auser_query(
        self,
        q: typing.Optional[str] = None,
        ids: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._user_query_mapped_args(
            q=q,
            ids=ids,
            limit=limit,
            offset=offset,
        ...
        return await self._auser_query_oapg(
    ...
    def user_query(
        ...
        return self._user_query_oapg(
            query_params=args.query,
        )

class UserQuery(BaseApi):
    ...
    async def auser_query(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.auser_query(
            q=q,
            ids=ids,
            limit=limit,
            offset=offset,
    ...
    def user_query(
        ...
        raw_response = self.raw.user_query(
            q=q,
            ids=ids,
            limit=limit,
            offset=offset,
