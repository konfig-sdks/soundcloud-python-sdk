...
class DeleteTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_track(
        self,
        track_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_track_mapped_args(
            track_id=track_id,
        )
        return await self._adelete_track_oapg(
    ...
    def delete_track(
        ...
        return self._delete_track_oapg(
            path_params=args.path,
        )

class DeleteTrack(BaseApi):
    ...
    async def adelete_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_track(
            track_id=track_id,
            **kwargs,
        )
    ...
    def delete_track(
        ...
        raw_response = self.raw.delete_track(
            track_id=track_id,
        )
