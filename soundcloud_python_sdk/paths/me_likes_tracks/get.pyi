...
class BaseApi(api_client.Api):
    ...
    def _list_liked_tracks_mapped_args(
        self,
    ...
    async def _alist_liked_tracks_oapg(
        self,
...
class ListLikedTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_liked_tracks(
        self,
        limit: typing.Optional[int] = None,
        access: typing.Optional[typing.List[str]] = None,
        linked_partitioning: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._list_liked_tracks_mapped_args(
            limit=limit,
            access=access,
            linked_partitioning=linked_partitioning,
        )
        return await self._alist_liked_tracks_oapg(
    ...
    def list_liked_tracks(
        ...
        return self._list_liked_tracks_oapg(
            query_params=args.query,
        )

class ListLikedTracks(BaseApi):
    ...
    async def alist_liked_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_liked_tracks(
            limit=limit,
            access=access,
            linked_partitioning=linked_partitioning,
            **kwargs,
    ...
    def list_liked_tracks(
        ...
        raw_response = self.raw.list_liked_tracks(
            limit=limit,
            access=access,
            linked_partitioning=linked_partitioning,
        )
