...
class BaseApi(api_client.Api):
    ...
    def _get_user_followings_mapped_args(
        self,
        user_id: int,
    ...
    async def _aget_user_followings_oapg(
        self,
...
class GetUserFollowingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_followings(
        self,
        user_id: int,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_user_followings_mapped_args(
            user_id=user_id,
            limit=limit,
        )
        return await self._aget_user_followings_oapg(
    ...
    def get_user_followings(
        ...
        return self._get_user_followings_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserFollowings(BaseApi):
    ...
    async def aget_user_followings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_followings(
            user_id=user_id,
            limit=limit,
            **kwargs,
        )
    ...
    def get_user_followings(
        ...
        raw_response = self.raw.get_user_followings(
            user_id=user_id,
            limit=limit,
        )
        if validate:
