...
class ByQuery0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aby_query_0(
        self,
        q: typing.Optional[str] = None,
        access: typing.Optional[typing.List[str]] = None,
        show_tracks: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._by_query_0_mapped_args(
            q=q,
            access=access,
        ...
        return await self._aby_query_0_oapg(
    ...
    def by_query_0(
        ...
        return self._by_query_0_oapg(
            query_params=args.query,
        )

class ByQuery0(BaseApi):
    ...
    async def aby_query_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aby_query_0(
            q=q,
            access=access,
            show_tracks=show_tracks,
            limit=limit,
    ...
    def by_query_0(
        ...
        raw_response = self.raw.by_query_0(
            q=q,
            access=access,
            show_tracks=show_tracks,
            limit=limit,
