...
class BaseApi(api_client.Api):
    ...
    def _get_user_playlists_mapped_args(
        self,
        user_id: int,
    ...
    async def _aget_user_playlists_oapg(
        self,
...
class GetUserPlaylistsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_playlists(
        self,
        user_id: int,
        access: typing.Optional[typing.List[str]] = None,
        show_tracks: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_playlists_mapped_args(
            user_id=user_id,
            access=access,
        ...
        return await self._aget_user_playlists_oapg(
    ...
    def get_user_playlists(
        ...
        return self._get_user_playlists_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserPlaylists(BaseApi):
    ...
    async def aget_user_playlists(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_playlists(
            user_id=user_id,
            access=access,
            show_tracks=show_tracks,
            limit=limit,
    ...
    def get_user_playlists(
        ...
        raw_response = self.raw.get_user_playlists(
            user_id=user_id,
            access=access,
            show_tracks=show_tracks,
            limit=limit,
