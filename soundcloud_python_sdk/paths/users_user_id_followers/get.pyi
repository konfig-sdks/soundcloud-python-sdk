...
class BaseApi(api_client.Api):
    ...
    def _get_followers_mapped_args(
        self,
        user_id: int,
    ...
    async def _aget_followers_oapg(
        self,
...
class GetFollowersRaw(BaseApi):
    ...
    async def aget_followers(
        ...
        **kwargs,
        ...
        args = self._get_followers_mapped_args(
            user_id=user_id,
            limit=limit,
        )
        return await self._aget_followers_oapg(
    ...
    def get_followers(
        ...
        return self._get_followers_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFollowers(BaseApi):
    ...
    async def aget_followers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_followers(
            user_id=user_id,
            limit=limit,
            **kwargs,
        )
    ...
    def get_followers(
        ...
        raw_response = self.raw.get_followers(
            user_id=user_id,
            limit=limit,
        )
        if validate:
