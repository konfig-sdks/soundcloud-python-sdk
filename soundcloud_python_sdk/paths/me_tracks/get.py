...
class BaseApi(api_client.Api):
    ...
    def _list_user_tracks_mapped_args(
        self,
    ...
    async def _alist_user_tracks_oapg(
        self,
...
class ListUserTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_user_tracks(
        self,
        limit: typing.Optional[int] = None,
        linked_partitioning: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._list_user_tracks_mapped_args(
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        return await self._alist_user_tracks_oapg(
    ...
    def list_user_tracks(
        ...
        return self._list_user_tracks_oapg(
            query_params=args.query,
        )

class ListUserTracks(BaseApi):
    ...
    async def alist_user_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_user_tracks(
            limit=limit,
            linked_partitioning=linked_partitioning,
            **kwargs,
        )
    ...
    def list_user_tracks(
        ...
        raw_response = self.raw.list_user_tracks(
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        if validate:
