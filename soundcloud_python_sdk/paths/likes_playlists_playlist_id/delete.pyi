...
class BaseApi(api_client.Api):
    ...
    def _unlike_playlist_mapped_args(
        self,
        playlist_id: int,
    ...
    async def _aunlike_playlist_oapg(
        self,
...
class UnlikePlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunlike_playlist(
        self,
        playlist_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unlike_playlist_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._aunlike_playlist_oapg(
    ...
    def unlike_playlist(
        ...
        return self._unlike_playlist_oapg(
            path_params=args.path,
        )

class UnlikePlaylist(BaseApi):
    ...
    async def aunlike_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunlike_playlist(
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def unlike_playlist(
        ...
        raw_response = self.raw.unlike_playlist(
            playlist_id=playlist_id,
        )
