...
class PlaylistRaw(BaseApi):
    ...
    async def aplaylist(
        ...
        **kwargs,
        ...
        args = self._playlist_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._aplaylist_oapg(
...
class Playlist(BaseApi):
    ...
    async def aplaylist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aplaylist(
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def playlist(
        ...
        raw_response = self.raw.playlist(
            playlist_id=playlist_id,
        )
