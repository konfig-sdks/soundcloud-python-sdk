...
from soundcloud_python_sdk.model.streams import Streams as StreamsSchema
from soundcloud_python_sdk.model.error import Error as ErrorSchema

from soundcloud_python_sdk.type.streams import Streams
...
from soundcloud_python_sdk.pydantic.streams import Streams as StreamsPydantic
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = StreamsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_streamable_urls_mapped_args(
        self,
        track_id: int,
    ...
    async def _aget_streamable_urls_oapg(
        self,
...
class GetStreamableUrlsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_streamable_urls(
        self,
        track_id: int,
        secret_token: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_streamable_urls_mapped_args(
            track_id=track_id,
            secret_token=secret_token,
        )
        return await self._aget_streamable_urls_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_streamable_urls(
        self,
        track_id: int,
        secret_token: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_streamable_urls_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetStreamableUrls(BaseApi):
    ...
    async def aget_streamable_urls(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_streamable_urls(
            track_id=track_id,
            secret_token=secret_token,
            **kwargs,
        )
        if validate:
            return StreamsPydantic(**raw_response.body)
        return api_client.construct_model_instance(StreamsPydantic, raw_response.body)
    ...
    def get_streamable_urls(
        ...
        raw_response = self.raw.get_streamable_urls(
            track_id=track_id,
            secret_token=secret_token,
        )
        if validate:
