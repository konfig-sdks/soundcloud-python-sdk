...
class GetUserRaw(BaseApi):
    ...
    async def aget_user(
        ...
        **kwargs,
        ...
        args = self._get_user_mapped_args(
            user_id=user_id,
        )
        return await self._aget_user_oapg(
...
class GetUser(BaseApi):
    ...
    async def aget_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user(
            user_id=user_id,
            **kwargs,
        )
        if validate:
    ...
    def get_user(
        ...
        raw_response = self.raw.get_user(
            user_id=user_id,
        )
        if validate:
            return UserPydantic(**raw_response.body)
