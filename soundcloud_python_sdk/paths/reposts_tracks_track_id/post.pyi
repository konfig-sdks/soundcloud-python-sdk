...
class BaseApi(api_client.Api):
    ...
    def _track_as_authenticated_user_mapped_args(
        self,
        track_id: int,
    ...
    async def _atrack_as_authenticated_user_oapg(
        self,
    ...
    def _track_as_authenticated_user_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class TrackAsAuthenticatedUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atrack_as_authenticated_user(
        self,
        track_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._track_as_authenticated_user_mapped_args(
            track_id=track_id,
        )
        return await self._atrack_as_authenticated_user_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def track_as_authenticated_user(
        self,
        track_id: int,
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._track_as_authenticated_user_oapg(
            path_params=args.path,
        )

class TrackAsAuthenticatedUser(BaseApi):
    ...
    async def atrack_as_authenticated_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atrack_as_authenticated_user(
            track_id=track_id,
            **kwargs,
        )
    ...
    def track_as_authenticated_user(
        ...
        raw_response = self.raw.track_as_authenticated_user(
            track_id=track_id,
        )
