...
class BaseApi(api_client.Api):
    ...
    def _remove_repost_mapped_args(
        self,
        track_id: int,
    ...
    async def _aremove_repost_oapg(
        self,
...
class RemoveRepostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_repost(
        self,
        track_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_repost_mapped_args(
            track_id=track_id,
        )
        return await self._aremove_repost_oapg(
    ...
    def remove_repost(
        ...
        return self._remove_repost_oapg(
            path_params=args.path,
        )

class RemoveRepost(BaseApi):
    ...
    async def aremove_repost(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_repost(
            track_id=track_id,
            **kwargs,
        )
    ...
    def remove_repost(
        ...
        raw_response = self.raw.remove_repost(
            track_id=track_id,
        )
