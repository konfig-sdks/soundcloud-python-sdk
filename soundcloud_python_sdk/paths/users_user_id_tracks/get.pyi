...
class BaseApi(api_client.Api):
    ...
    def _get_user_tracks_mapped_args(
        self,
        user_id: int,
    ...
    async def _aget_user_tracks_oapg(
        self,
...
class GetUserTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_tracks(
        self,
        user_id: int,
        access: typing.Optional[typing.List[str]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_tracks_mapped_args(
            user_id=user_id,
            access=access,
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        return await self._aget_user_tracks_oapg(
    ...
    def get_user_tracks(
        ...
        return self._get_user_tracks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserTracks(BaseApi):
    ...
    async def aget_user_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_tracks(
            user_id=user_id,
            access=access,
            limit=limit,
            linked_partitioning=linked_partitioning,
    ...
    def get_user_tracks(
        ...
        raw_response = self.raw.get_user_tracks(
            user_id=user_id,
            access=access,
            limit=limit,
            linked_partitioning=linked_partitioning,
