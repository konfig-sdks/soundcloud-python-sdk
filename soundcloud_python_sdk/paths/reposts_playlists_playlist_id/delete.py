...
class BaseApi(api_client.Api):
    ...
    def _remove_repost_on_playlist_mapped_args(
        self,
        playlist_id: int,
    ...
    async def _aremove_repost_on_playlist_oapg(
        self,
    ...
    def _remove_repost_on_playlist_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveRepostOnPlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_repost_on_playlist(
        self,
        playlist_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_repost_on_playlist_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._aremove_repost_on_playlist_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_repost_on_playlist(
        self,
        playlist_id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._remove_repost_on_playlist_oapg(
            path_params=args.path,
        )

class RemoveRepostOnPlaylist(BaseApi):
    ...
    async def aremove_repost_on_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_repost_on_playlist(
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def remove_repost_on_playlist(
        ...
        raw_response = self.raw.remove_repost_on_playlist(
            playlist_id=playlist_id,
        )
