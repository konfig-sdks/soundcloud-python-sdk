...
class UnlikeTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunlike_track(
        self,
        track_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unlike_track_mapped_args(
            track_id=track_id,
        )
        return await self._aunlike_track_oapg(
    ...
    def unlike_track(
        ...
        return self._unlike_track_oapg(
            path_params=args.path,
        )

class UnlikeTrack(BaseApi):
    ...
    async def aunlike_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunlike_track(
            track_id=track_id,
            **kwargs,
        )
    ...
    def unlike_track(
        ...
        raw_response = self.raw.unlike_track(
            track_id=track_id,
        )
