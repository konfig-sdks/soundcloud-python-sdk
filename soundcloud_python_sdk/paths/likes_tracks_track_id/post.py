...
class TrackActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atrack_action(
        self,
        track_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._track_action_mapped_args(
            track_id=track_id,
        )
        return await self._atrack_action_oapg(
    ...
    def track_action(
        ...
        return self._track_action_oapg(
            path_params=args.path,
        )

class TrackAction(BaseApi):
    ...
    async def atrack_action(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atrack_action(
            track_id=track_id,
            **kwargs,
        )
    ...
    def track_action(
        ...
        raw_response = self.raw.track_action(
            track_id=track_id,
        )
