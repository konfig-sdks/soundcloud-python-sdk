...
class GetTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tracks(
        self,
        playlist_id: int,
        secret_token: typing.Optional[str] = None,
        access: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._get_tracks_mapped_args(
            playlist_id=playlist_id,
            secret_token=secret_token,
            access=access,
            linked_partitioning=linked_partitioning,
        )
        return await self._aget_tracks_oapg(
    ...
    def get_tracks(
        ...
        return self._get_tracks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTracks(BaseApi):
    ...
    async def aget_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tracks(
            playlist_id=playlist_id,
            secret_token=secret_token,
            access=access,
            linked_partitioning=linked_partitioning,
    ...
    def get_tracks(
        ...
        raw_response = self.raw.get_tracks(
            playlist_id=playlist_id,
            secret_token=secret_token,
            access=access,
            linked_partitioning=linked_partitioning,
