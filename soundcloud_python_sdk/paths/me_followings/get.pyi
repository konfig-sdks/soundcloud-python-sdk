...
class BaseApi(api_client.Api):
    ...
    def _get_followed_users_mapped_args(
        self,
    ...
    async def _aget_followed_users_oapg(
        self,
...
class GetFollowedUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_followed_users(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_followed_users_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_followed_users_oapg(
    ...
    def get_followed_users(
        ...
        return self._get_followed_users_oapg(
            query_params=args.query,
        )

class GetFollowedUsers(BaseApi):
    ...
    async def aget_followed_users(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_followed_users(
            limit=limit,
            offset=offset,
            **kwargs,
        )
    ...
    def get_followed_users(
        ...
        raw_response = self.raw.get_followed_users(
            limit=limit,
            offset=offset,
        )
        if validate:
