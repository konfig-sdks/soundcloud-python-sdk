...
class BaseApi(api_client.Api):
    ...
    def _get_related_tracks_mapped_args(
        self,
        track_id: int,
    ...
    async def _aget_related_tracks_oapg(
        self,
...
class GetRelatedTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_related_tracks(
        self,
        track_id: int,
        access: typing.Optional[typing.List[str]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_related_tracks_mapped_args(
            track_id=track_id,
            access=access,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_related_tracks_oapg(
    ...
    def get_related_tracks(
        ...
        return self._get_related_tracks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRelatedTracks(BaseApi):
    ...
    async def aget_related_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_related_tracks(
            track_id=track_id,
            access=access,
            limit=limit,
            offset=offset,
    ...
    def get_related_tracks(
        ...
        raw_response = self.raw.get_related_tracks(
            track_id=track_id,
            access=access,
            limit=limit,
            offset=offset,
