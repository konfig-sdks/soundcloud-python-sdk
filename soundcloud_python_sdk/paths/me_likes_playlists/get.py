...
class BaseApi(api_client.Api):
    ...
    def _get_liked_playlists_mapped_args(
        self,
    ...
    async def _aget_liked_playlists_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/likes/playlists',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetLikedPlaylistsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_liked_playlists(
        self,
        limit: typing.Optional[int] = None,
        linked_partitioning: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._get_liked_playlists_mapped_args(
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        return await self._aget_liked_playlists_oapg(
    ...
    def get_liked_playlists(
        ...
        return self._get_liked_playlists_oapg(
            query_params=args.query,
        )

class GetLikedPlaylists(BaseApi):
    ...
    async def aget_liked_playlists(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_liked_playlists(
            limit=limit,
            linked_partitioning=linked_partitioning,
            **kwargs,
        )
    ...
    def get_liked_playlists(
        ...
        raw_response = self.raw.get_liked_playlists(
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        if validate:
