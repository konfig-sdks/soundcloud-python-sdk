...
class BaseApi(api_client.Api):
    ...
    def _get_favoriters_mapped_args(
        self,
        track_id: int,
    ...
    async def _aget_favoriters_oapg(
        self,
...
class GetFavoritersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_favoriters(
        self,
        track_id: int,
        limit: typing.Optional[int] = None,
        linked_partitioning: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._get_favoriters_mapped_args(
            track_id=track_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        return await self._aget_favoriters_oapg(
    ...
    def get_favoriters(
        ...
        return self._get_favoriters_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFavoriters(BaseApi):
    ...
    async def aget_favoriters(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_favoriters(
            track_id=track_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
            **kwargs,
    ...
    def get_favoriters(
        ...
        raw_response = self.raw.get_favoriters(
            track_id=track_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
