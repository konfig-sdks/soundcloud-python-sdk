...
class BaseApi(api_client.Api):
    ...
    def _get_followed_user_mapped_args(
        self,
        user_id: int,
    ...
    async def _aget_followed_user_oapg(
        self,
...
class GetFollowedUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="me")
    async def aget_followed_user(
        self,
        user_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_followed_user_mapped_args(
            user_id=user_id,
        )
        return await self._aget_followed_user_oapg(
    ...
    def get_followed_user(
        ...
        return self._get_followed_user_oapg(
            path_params=args.path,
        )

class GetFollowedUser(BaseApi):
    ...
    async def aget_followed_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_followed_user(
            user_id=user_id,
            **kwargs,
        )
        if validate:
    ...
    def get_followed_user(
        ...
        raw_response = self.raw.get_followed_user(
            user_id=user_id,
        )
        if validate:
            return UserPydantic(**raw_response.body)
