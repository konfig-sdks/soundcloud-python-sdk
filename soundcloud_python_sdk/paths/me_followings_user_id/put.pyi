...
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = UserSchema
...
class FollowUserRaw(BaseApi):
    ...
    async def afollow_user(
        ...
        **kwargs,
        ...
        args = self._follow_user_mapped_args(
            user_id=user_id,
        )
        return await self._afollow_user_oapg(
    ...
    def follow_user(
        ...
        return self._follow_user_oapg(
            path_params=args.path,
        )

class FollowUser(BaseApi):
    ...
    async def afollow_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afollow_user(
            user_id=user_id,
            **kwargs,
        )
    ...
    def follow_user(
        ...
        raw_response = self.raw.follow_user(
            user_id=user_id,
        )
