...
class BaseApi(api_client.Api):
    ...
    def _delete_followed_user_mapped_args(
        self,
        user_id: int,
    ...
    async def _adelete_followed_user_oapg(
        self,
    ...
    def _delete_followed_user_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteFollowedUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_followed_user(
        self,
        user_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_followed_user_mapped_args(
            user_id=user_id,
        )
        return await self._adelete_followed_user_oapg(
    ...
    def delete_followed_user(
        ...
        return self._delete_followed_user_oapg(
            path_params=args.path,
        )

class DeleteFollowedUser(BaseApi):
    ...
    async def adelete_followed_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_followed_user(
            user_id=user_id,
            **kwargs,
        )
    ...
    def delete_followed_user(
        ...
        raw_response = self.raw.delete_followed_user(
            user_id=user_id,
        )
