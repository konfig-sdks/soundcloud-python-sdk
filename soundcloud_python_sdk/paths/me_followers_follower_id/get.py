...
from soundcloud_python_sdk.model.user import User as UserSchema
...
from soundcloud_python_sdk.pydantic.user import User as UserPydantic

from . import path

# Path params
FollowerIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'follower_id': typing.Union[FollowerIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_follower_id = api_client.PathParameter(
    name="follower_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FollowerIdSchema,
    required=True,
)
_auth = [
    'AuthHeader',
]
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = UserSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_follower_by_id_mapped_args(
        self,
        follower_id: int,
        ...
        if follower_id is not None:
            _path_params["follower_id"] = follower_id
        args.path = _path_params
        return args

    async def _aget_follower_by_id_oapg(
        self,
...
class GetFollowerByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="me")
    async def aget_follower_by_id(
        self,
        follower_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_follower_by_id_mapped_args(
            follower_id=follower_id,
        )
        return await self._aget_follower_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="me")
    def get_follower_by_id(
        self,
        follower_id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_follower_by_id_oapg(
            path_params=args.path,
        )

class GetFollowerById(BaseApi):
    ...
    async def aget_follower_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_follower_by_id(
            follower_id=follower_id,
            **kwargs,
        )
        if validate:
    ...
    def get_follower_by_id(
        ...
        raw_response = self.raw.get_follower_by_id(
            follower_id=follower_id,
        )
        if validate:
            return UserPydantic(**raw_response.body)
