...
class BaseApi(api_client.Api):
    ...
    def _delete_playlist_mapped_args(
        self,
        playlist_id: int,
    ...
    async def _adelete_playlist_oapg(
        self,
...
class DeletePlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_playlist(
        self,
        playlist_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_playlist_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._adelete_playlist_oapg(
    ...
    def delete_playlist(
        ...
        return self._delete_playlist_oapg(
            path_params=args.path,
        )

class DeletePlaylist(BaseApi):
    ...
    async def adelete_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_playlist(
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def delete_playlist(
        ...
        raw_response = self.raw.delete_playlist(
            playlist_id=playlist_id,
        )
