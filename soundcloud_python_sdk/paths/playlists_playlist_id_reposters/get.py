...
class BaseApi(api_client.Api):
    ...
    def _list_reposters_mapped_args(
        self,
        playlist_id: int,
    ...
    async def _alist_reposters_oapg(
        self,
...
class ListRepostersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_reposters(
        self,
        playlist_id: int,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_reposters_mapped_args(
            playlist_id=playlist_id,
            limit=limit,
        )
        return await self._alist_reposters_oapg(
    ...
    def list_reposters(
        ...
        return self._list_reposters_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListReposters(BaseApi):
    ...
    async def alist_reposters(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_reposters(
            playlist_id=playlist_id,
            limit=limit,
            **kwargs,
        )
    ...
    def list_reposters(
        ...
        raw_response = self.raw.list_reposters(
            playlist_id=playlist_id,
            limit=limit,
        )
        if validate:
