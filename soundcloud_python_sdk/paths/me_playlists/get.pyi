...
# Query params
ShowTracksSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'show_tracks': typing.Union[ShowTracksSchema, bool, ],
...
request_query_show_tracks = api_client.QueryParameter(
    name="show_tracks",
    style=api_client.ParameterStyle.FORM,
    schema=ShowTracksSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _list_playlists_info_tracks_owner_mapped_args(
        self,
        show_tracks: typing.Optional[bool] = None,
        ...
        if show_tracks is not None:
            _query_params["show_tracks"] = show_tracks
    ...
    async def _alist_playlists_info_tracks_owner_oapg(
        self,
    ...
    def _list_playlists_info_tracks_owner_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListPlaylistsInfoTracksOwnerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_playlists_info_tracks_owner(
        self,
        show_tracks: typing.Optional[bool] = None,
        linked_partitioning: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_playlists_info_tracks_owner_mapped_args(
            show_tracks=show_tracks,
            linked_partitioning=linked_partitioning,
            limit=limit,
        )
        return await self._alist_playlists_info_tracks_owner_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_playlists_info_tracks_owner(
        self,
        show_tracks: typing.Optional[bool] = None,
        linked_partitioning: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_playlists_info_tracks_owner_oapg(
            query_params=args.query,
        )

class ListPlaylistsInfoTracksOwner(BaseApi):
    ...
    async def alist_playlists_info_tracks_owner(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_playlists_info_tracks_owner(
            show_tracks=show_tracks,
            linked_partitioning=linked_partitioning,
            limit=limit,
            **kwargs,
    ...
    def list_playlists_info_tracks_owner(
        ...
        raw_response = self.raw.list_playlists_info_tracks_owner(
            show_tracks=show_tracks,
            linked_partitioning=linked_partitioning,
            limit=limit,
        )
