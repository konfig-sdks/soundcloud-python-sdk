...
class BaseApi(api_client.Api):
    ...
    def _list_favorites_mapped_args(
        self,
        user_id: int,
    ...
    async def _alist_favorites_oapg(
        self,
...
class ListFavoritesRaw(BaseApi):
    ...
    async def alist_favorites(
        ...
        **kwargs,
        ...
        args = self._list_favorites_mapped_args(
            user_id=user_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
        return await self._alist_favorites_oapg(
    ...
    def list_favorites(
        ...
        return self._list_favorites_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListFavorites(BaseApi):
    ...
    async def alist_favorites(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_favorites(
            user_id=user_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
            **kwargs,
    ...
    def list_favorites(
        ...
        raw_response = self.raw.list_favorites(
            user_id=user_id,
            limit=limit,
            linked_partitioning=linked_partitioning,
        )
