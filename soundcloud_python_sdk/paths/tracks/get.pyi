...
from soundcloud_python_sdk.model.me_list_liked_tracks_response import MeListLikedTracksResponse as MeListLikedTracksResponseSchema
from soundcloud_python_sdk.model.error import Error as ErrorSchema

from soundcloud_python_sdk.type.me_list_liked_tracks_response import MeListLikedTracksResponse
...
from soundcloud_python_sdk.pydantic.me_list_liked_tracks_response import MeListLikedTracksResponse as MeListLikedTracksResponsePydantic

# Query params
QSchema = schemas.StrSchema
IdsSchema = schemas.StrSchema
GenresSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'genres': typing.Union[GenresSchema, str, ],
        'tags': typing.Union[TagsSchema, str, ],
        'bpm': typing.Union[BpmSchema, dict, frozendict.frozendict, ],
        'duration': typing.Union[DurationSchema, dict, frozendict.frozendict, ],
        'created_at': typing.Union[CreatedAtSchema, dict, frozendict.frozendict, ],
        'access': typing.Union[AccessSchema, list, tuple, ],
...
request_query_genres = api_client.QueryParameter(
    name="genres",
    style=api_client.ParameterStyle.FORM,
    schema=GenresSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = MeListLikedTracksResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MeListLikedTracksResponse
...
class BaseApi(api_client.Api):
    ...
    def _by_query_mapped_args(
        self,
        q: typing.Optional[str] = None,
        ids: typing.Optional[str] = None,
        genres: typing.Optional[str] = None,
        tags: typing.Optional[str] = None,
        bpm: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        duration: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        created_at: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
...
class ByQueryRaw(BaseApi):
    ...
    async def aby_query(
        ...
        **kwargs,
        ...
        args = self._by_query_mapped_args(
            q=q,
            ids=ids,
            genres=genres,
            tags=tags,
        ...
        return await self._aby_query_oapg(
    ...
    def by_query(
        ...
        return self._by_query_oapg(
            query_params=args.query,
        )

class ByQuery(BaseApi):
    ...
    async def aby_query(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MeListLikedTracksResponsePydantic:
        raw_response = await self.raw.aby_query(
            q=q,
            ids=ids,
            genres=genres,
            tags=tags,
        ...
        if validate:
            return RootModel[MeListLikedTracksResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(MeListLikedTracksResponsePydantic, raw_response.body)
    ...
    def by_query(
        ...
        raw_response = self.raw.by_query(
            q=q,
            ids=ids,
            genres=genres,
            tags=tags,
